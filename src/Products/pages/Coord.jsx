...
//           `http://localhost:5001/api/products/coords?search=${debouncedQuery}&page=${currentPage}&limit=${ITEMS_PER_PAGE}&price=${priceOrder}`
//         );
...
//         <input
//           type="text"
//           placeholder="Search coords dress..."
//           value={searchQuery}
//           onChange={(e) => {
...
export default function CoordPage() {
  return (
    <CategoryProductsPage category="coords" placeholder="Search coords..." />
  );
}
