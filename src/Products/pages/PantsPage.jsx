...
//           `http://localhost:5001/api/products/pants?search=${debouncedQuery}&page=${currentPage}&limit=${ITEMS_PER_PAGE}&price=${priceOrder}`
//         );
...
export default function PantsPage() {
  return (
    <CategoryProductsPage category="pants" placeholder="Search pants..." />
  );
}
