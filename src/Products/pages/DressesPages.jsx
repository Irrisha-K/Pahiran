...
//           `http://localhost:5001/api/products/dresses?search=${debouncedQuery}&page=${currentPage}&limit=${ITEMS_PER_PAGE}&price=${priceOrder}`
//         );
...
export default function DressesPage() {
  return (
    <CategoryProductsPage category="dresses" placeholder="Search dresses..." />
  );
}
